                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="space-y-8">
                            ...
                            <div className="flex justify-center lg:justify-start gap-4 pt-6">
                                <a href="https://twitter.com/tojacytryn" target="_blank" className="w-12 h-12 bg-gray-800/50 rounded-full flex items-center justify-center hover:bg-yellow-400/20 hover:text-yellow-400 transition-all duration-300 border border-white/10 hover:border-yellow-400/30">
